...
namespace GDMWebService
{
    ...
    public static class AccessLayer
    {
        ...
        static Logger logger = LogManager.GetLogger("GEO");
        static Logger log = LogManager.GetLogger("GEOLog");
        static Logger sqLogger = LogManager.GetLogger("GEOSQL");
        private static string Mturk = "";
        ...
        public static bool InsertIntoExperimentActions(int ExperimentID, int PersonID, string VertexID, string Color, DateTime EventTime)
        {
            ...
            sqLogger.Info("INSERT INTO ExperimentActions VALUES ("+ExperimentID+", "+PersonID+", "+VertexID+", "+Color+", "+EventTime+")");
            SqlCommand cmd = new SqlCommand(query, SqlCon);
        ...
        public static int InsertExperimentGraph(string graph_xml)
        {
            ...
            sqLogger.Info("Insert INTO InputGraph (InputGraph) VALUES ("+graph_xml+")");
            SqlCommand cmd = new SqlCommand(query, SqlCon);
        ...
        public static bool SolvedProblemGraph(int ParticipantID, bool Solved, DateTime SolvedTime)
        {
            ...
            if (entery)
            {
                ...
                sqLogger.Info("UPDATE ExperimentResult SET Solved = "+Solved+", SolvedTime = "+SolvedTime+" " +
                "WHERE ParticipantID = "+ParticipantID+" AND ExperimentID = "+ExperimentID);
            }
            else
            {
                ...
                sqLogger.Info("INSERT INTO ExperimentResult (ParticipantID, ExperimentID, Solved, SolvedTime) " +
                    "VALUES ("+ParticipantID+", "+ExperimentID+","+Solved+","+SolvedTime+")");
            }
            SqlCommand cmd = new SqlCommand(query, SqlCon);
            ...
            log.Trace("Results,{0},{1},{2},{3}", ParticipantID, Mturk, Solved, SolvedTime);
