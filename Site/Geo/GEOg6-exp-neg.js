...
bgu_url = "http://hdm.ise.bgu.ac.il/GEO3.more/GDMVisualizationTestPage.html"
experiment ="GEO-6-EXP-Negative"
	...
	//			$("#btnContinue").html('Continue')
	    ...
	    case 14:
	        ...
	        servlog("voteOwnExp", explanationVote)
	       	 ...
	       	 rateA=$("#range_A").val()
	        servlog("conf.A",rateA)
	         rateB=$("#range_B").val()
	        servlog("conf.B",rateB)
	         rateO=$("#range_O").val()
	        servlog("conf.Own",rateO)
	        	rateSol=$("#range_Sol").val()
	        servlog("conf.Sol",rateO)
