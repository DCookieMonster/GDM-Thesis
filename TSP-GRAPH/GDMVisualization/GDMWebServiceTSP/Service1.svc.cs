...
namespace GDMWebServiceTSP
{
    ...
    public static class AccessLayer
    {
       ...
       // static SqlConnection SqlCon = new SqlConnection(connGDM); 
        ...
        static Logger logger = LogManager.GetLogger("TSPGDM");
        static Logger m_logger = LogManager.GetLogger("TSP");
        static Logger m_SQLlog = LogManager.GetLogger("TSPSQL");
        static string m_torkID = "";
        ...
        public static int GetCurrentExperimentID()
        {
            ...
            {   
                ...
                logger.Error("GetCurrentExperimentID: sqlConnectionError - "+exception.Message);
            }
        ...
        public static string GetExperimentGraph()
        {
            ...
            catch (Exception exception) { graph = "error loading graph";
            logger.Error("GetExperimentGraph: sqlConnectionError - "+exception.Message);
            }
            finally { SqlCon.Close(); }
        ...
        public static byte[] GetSolutionGraph()
        {
            ...
            { logger.Error("GetSolutionGraph: sqlConnectionError - "+exception.Message); }
            finally { SqlCon.Close(); }
        ...
        public static string GetUseSolutionGraph()
        {
            ...
            { logger.Error("GetUseSolutionGraph: sqlConnectionError - "+exception.Message); }
            finally { SqlCon.Close(); }
        ...
        public static bool InsertIntoExperimentActions(int ExperimentID, int PersonID, string VertexID, string Color, DateTime EventTime)
        {
            ...
            m_SQLlog.Info( "INSERT INTO ExperimentActions VALUES ("+ExperimentID+","+PersonID+","+VertexID+","+Color+","+EventTime+")");
            SqlCommand cmd = new SqlCommand(query, SqlCon);
            ...
            { ans = false;
            logger.Error("ExperimentActions: sqlConnectionError - " + exception.Message);
            }
            finally { SqlCon.Close(); }
        ...
        public static int AddParticipant(string TurkID)
        {
            ...
            m_SQLlog.Info("INSERT INTO Participant (TurkID) VALUES ('" + TurkID + "')");
            SqlCommand cmd = new SqlCommand(query, SqlCon);
            try
            {
                SqlCon.Open();
          ...
          /*  for (int i = 0; i < 100; ++i)
            {
                ...
                {
                    logger.Error("Add: sqlConnectionError" + i + " " + exception.Message);
                }
                finally
                {
                    SqlCon.Close();
            ...
            {
                logger.Error("Add: sqlConnectionError - "+ exception.Message);
            }
            finally { SqlCon.Close(); }
       
            //logger.Info("Added: id={0}, code={1}", id,TurkID);
            logger.Info("Add,{0},{1}", id, TurkID);
            m_logger.Info("Add,{0},{1}", id, TurkID);
        ...
        public static int InsertExperimentGraph(string graph_xml)
        {
            ...
            m_SQLlog.Info("Insert INTO InputGraph (InputGraph) VALUES ("+graph_xml+")");
            SqlCommand cmd = new SqlCommand(query, SqlCon);
            ...
            { logger.Error("InsertExperimentGraph: sqlConnectionError - "+exception.Message); }
            finally
            {
                SqlCon.Close();
        ...
        public static bool SolvedProblemGraph(int ParticipantID, bool Solved, DateTime SolvedTime)
        {
            ...
            if (entery)
            {
                ...
                m_SQLlog.Info("UPDATE ExperimentResult SET Solved ="+Solved +", SolvedTime = "+SolvedTime+"" +
                              " WHERE ParticipantID = "+ParticipantID+" AND ExperimentID ="+ExperimentID);
            }
            else
            {
                ...
                m_SQLlog.Info("INSERT INTO ExperimentResult (ParticipantID, ExperimentID, Solved, SolvedTime) " +
                    "VALUES ("+ParticipantID+","+ExperimentID+","+Solved+","+SolvedTime+")");
            }
            SqlCommand cmd = new SqlCommand(query, SqlCon);
            ...
            { ans = false;
            logger.Error("Results: sqlConnectionError "+exception.Message);
            }
            finally { SqlCon.Close(); }
            ...
            m_logger.Trace("Results,{0},{1},{2},{3}", ParticipantID,m_torkID, Solved, SolvedTime);
        ...
        public static bool SolutionAcceptancePartial(int ParticipantID, int ExperimentID, DateTime Date, bool AcceptedSolution)
        {
            ...
            { ans = false;
            logger.Error("SolutionAcceptancePartial: sqlConnectionError - " + exception.Message);
            }
            finally { SqlCon.Close(); }
            return ans;
        }
